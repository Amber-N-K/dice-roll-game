...
const game0El = document.getElementById('game--0');
const game1El = document.getElementById('game--1');
...
btnHold.addEventListener('click', function() {
    ...
    // Add current score to active player's score
        ...
        if (scores[activePlayer] >= 100) {
            ...
            // Change background for the player that lost the game
            ...
            document.getElementById(`game--${activePlayer}`).textContent = 'Win!'
            document
                .querySelector(`.player--${activePlayer}`)
